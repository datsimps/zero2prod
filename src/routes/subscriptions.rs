    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            SubscribeError::PoolError(_) => {
                write!(f, "Failed to acquire a Postgres connection pool.")
            },
            ...
            SubscribeError::StoreTokenError(e) => write!(f,
...
pub async fn send_comfirmation_email(
